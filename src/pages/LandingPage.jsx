...
const DOWNLOADS = {
  ...
  mac: "https://github.com/diarise/kalp-resto/releases/download/v1.0.0/Kalpe.Resto-POS-0.0.0-arm64.dmg",
};
            ...
            {modalStep === "code" ? (
              ...
              <>
                ...
                <div className="space-y-3">
                  ...
                  <a href={DOWNLOADS.mac} target="_blank" rel="noopener noreferrer" className="w-full h-16 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-100 font-bold flex items-center justify-center gap-2 transition-all active:scale-95 text-base border border-slate-700">
